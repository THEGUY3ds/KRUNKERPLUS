...
class Utilities {
   ...
   updateInfoBox() {
        ...
        if (infoBox) {
            ...
            infoBox.innerHTML = '<h1><div class="utilitiesTitle"><div><span style="color:#fff800;">K</span><span style="color:#ffe700;">R</span><span style="color:#ffd600;">U</span><span style="color:#ffc500;">N</span><span style="color:#ffb400;">K</span><span style="color:#faa631;">E</span><span style="color:#f59762;">R</span><span style="color:#f08992;">P</span><span style="color:#eb7ac3;">L</span><span style="color:#e66cf4;">U</span><span style="color:#ec5bc1;">S</span><span style="color:#f24a8e;"> </span><span style="color:#f7385a;">V</span><span style="color:#fd2727;">3</span></div></div></h1>' + lines.join('').trim();
        }
    }
